...
const GifGallery = ({ slice }) => {
        ...
        {img ? (
          <div className={portfolioStyles.imageWrapper}>
            <img
              ...
              imgClassName={portfolioStyles.imageGrid}
              className={portfolioStyles.imageGridWrap}
            />
  ...
  return (
    <>
      <div
        className={`${portfolioStyles.layoutSection} ${portfolioStyles.columnTop} sectionMaxWidth`}
      >
        <div className={portfolioStyles.twoColumn}>
          <div className={portfolioStyles.textSection}>{isTitle(slice)}</div>

          <div
            className={`${
              portfolioStyles.columnGallery
            } sectionMaxWidth ${gridColumn(
