...
// If type is 'okay' then turn icon to okay, if Icon to 'no' then no

const ToastModule = ({message, type}) => {
    const typeIcon = (typeMessage) => {
        console.log(`This type is ${typeMessage}`)
    }
    return (
