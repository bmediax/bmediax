                ...
                <div className="pageColumnLayout sectionMaxWidth">
                    <div className="pageOneColumn">
                        ...
                        <div className="pageColumnLayout" style={{ marginTop: "30px" }}>
                            <StaticImage src="../images/profile/brianSkills2015.jpg" alt="SkillsUSA National 2015 Competition" imgClassName="galleryImg" className="galleryImgWrap pageTwoColumn" style={{ flex: "1" }} />
